...
- **Schema Contracts Directory:** `contracts/schema/`
- **Semantic Contracts Directory:** `contracts/semantic/`

## 5. Structured Signal to Knowledge Linkage
...
## 6. Controlled Quality Issues & Risk Matrix Summary
